...
<ScrollView>
      ...
      <Pressable>
        <Text style={{
          fontSize: 13,
          fontWeight: "500"
        }}>Delivery to Ashish - Rishikesh 249201</Text>
      </Pressable>
...
>
  ...
  />
   ...
   <BottomModal
    ...
    onTouchOutside={() => setVisibleModal(!visible)}    
    >
      <ModalContent style={{width: "100%", height:400}}>
        <View style={{
          ...
          }}>Select a delivery location to see product availablity and delivery option</Text>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} >
          ...
          onPress={() => {
           ...
           style={{
            ...
            }}>Add an Address on pickup point</Text>
          </Pressable>
        </ScrollView>
